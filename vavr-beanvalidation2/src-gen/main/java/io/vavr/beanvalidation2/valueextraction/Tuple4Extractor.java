...
public interface Tuple4Extractor {
    ...
    class FirstExtractor implements ValueExtractor<Tuple4<@ExtractedValue ?, ?, ?, ?>> {
        @Override
    ...
    class SecondExtractor implements ValueExtractor<Tuple4<?, @ExtractedValue ?, ?, ?>> {
        @Override
        public void extractValues(Tuple4<?, ?, ?, ?> originalValue, ValueReceiver receiver) {
    ...
    class ThirdExtractor implements ValueExtractor<Tuple4<?, ?, @ExtractedValue ?, ?>> {
        @Override
        public void extractValues(Tuple4<?, ?, ?, ?> originalValue, ValueReceiver receiver) {
    ...
    class FourthExtractor implements ValueExtractor<Tuple4<?, ?, ?, @ExtractedValue ?>> {
        @Override
        public void extractValues(Tuple4<?, ?, ?, ?> originalValue, ValueReceiver receiver) {
