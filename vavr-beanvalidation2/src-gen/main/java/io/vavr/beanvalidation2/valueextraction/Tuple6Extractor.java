...
public interface Tuple6Extractor {
    ...
    class FirstExtractor implements ValueExtractor<Tuple6<@ExtractedValue ?, ?, ?, ?, ?, ?>> {
        @Override
    ...
    class SecondExtractor implements ValueExtractor<Tuple6<?, @ExtractedValue ?, ?, ?, ?, ?>> {
        @Override
        public void extractValues(Tuple6<?, ?, ?, ?, ?, ?> originalValue, ValueReceiver receiver) {
    ...
    class ThirdExtractor implements ValueExtractor<Tuple6<?, ?, @ExtractedValue ?, ?, ?, ?>> {
        @Override
        public void extractValues(Tuple6<?, ?, ?, ?, ?, ?> originalValue, ValueReceiver receiver) {
    ...
    class FourthExtractor implements ValueExtractor<Tuple6<?, ?, ?, @ExtractedValue ?, ?, ?>> {
        @Override
        public void extractValues(Tuple6<?, ?, ?, ?, ?, ?> originalValue, ValueReceiver receiver) {
    ...
    class FifthExtractor implements ValueExtractor<Tuple6<?, ?, ?, ?, @ExtractedValue ?, ?>> {
        @Override
        public void extractValues(Tuple6<?, ?, ?, ?, ?, ?> originalValue, ValueReceiver receiver) {
    ...
    class SixthExtractor implements ValueExtractor<Tuple6<?, ?, ?, ?, ?, @ExtractedValue ?>> {
        @Override
        public void extractValues(Tuple6<?, ?, ?, ?, ?, ?> originalValue, ValueReceiver receiver) {
