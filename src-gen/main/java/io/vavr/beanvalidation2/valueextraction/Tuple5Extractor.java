  ...
  public interface Tuple5Extractor {
        ...
        class FirstExtractor implements ValueExtractor<Tuple5<@ExtractedValue ?, ?, ?, ?, ?>> {
        ...
        class SecondExtractor implements ValueExtractor<Tuple5<?, @ExtractedValue ?, ?, ?, ?>> {
        ...
        class ThirdExtractor implements ValueExtractor<Tuple5<?, ?, @ExtractedValue ?, ?, ?>> {
        ...
        class FourthExtractor implements ValueExtractor<Tuple5<?, ?, ?, @ExtractedValue ?, ?>> {
        ...
        class FifthExtractor implements ValueExtractor<Tuple5<?, ?, ?, ?, @ExtractedValue ?>> {
